...
= 2.5 =
* Improve handling of post revisions.

= 2.4 =
* Improved dialog box handling.

= 2.3 =
* Use new CURLFile class in PHP 5.6.
...
== Upgrade Notice ==
= 2.6 =
Recommended update. Minor bug fixes.

= 2.5 =
Recommended update. Resolves an issue with downloading revised text into a post revision.

= 2.4 =
Recommended update. Improved dialog box handling.

= 2.3 =
Recommended update. Resolves file transfer issues for sites running PHP 5.6
