...
?>
    ...
    <script type="text/javascript" >
        ...
        jQuery(document).ready(function($) {
            ...
            // Init. Scribendi namespace
            if ( ! $.Scribendi ) $.Scribendi = {};
            ...
            $('#scribendi-advanced-settings').click(function(e){
                ...
                var $disabled_inputs = $('.scribendi_disabled');

                if ( $disabled_inputs.length ) {

                    var adv_confirm = confirm("These settings should only be adjusted if recommended by Scribendi technical support.  Adjusting them may cause the plugin to stop working.");
            ...
            eventer(messageEvent, function(e) {
                ...
                if ( e.data == 'close-iframe' )
                    $.Scribendi.oDialog.dialog('close');
...
function scribendiRegisterDialog ( $ )
{
    ...
    $.Scribendi.oDialog = register_iframe_wrap.dialog({
		dialogClass:    'wp-dialog',
		modal:          true,
        zIndex:         999999,
		width:          '760',
...
function scribendiLoginDialog ( $ )
{
    ...
    login_iframe.attr("height", "95%");

    $.Scribendi.oDialog = login_iframe_wrap.dialog({
		dialogClass:    'wp-dialog',
		modal:          true,
        zIndex:         999999,
		width:          '760',
